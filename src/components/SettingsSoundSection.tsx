  ...
  return (
    <section className="flex flex-col gap-3 rounded-lg border border-gray-200 px-4 py-3 dark:border-gray-700">
      ...
      <button
        ...
        disabled={!soundEnabled}
        className="touch-manipulation self-start rounded-lg border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-800"
      >
        {t.settings.sfxTestButton}
      </button>
    </section>
  )
}
