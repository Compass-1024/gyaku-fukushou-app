...
export const ja: Translations = {
  ...
  privacy: {
    ...
    notificationsBody:
      '「設定」画面の「リマインド通知」は既定でオフのオプトイン機能です。オンにすると、その日プレイしたかどうか・通知希望時刻・プッシュ購読情報が本アプリのサーバー（Vercel Serverless Functions）へ送信されます。トレーニング履歴の内容そのものは送信されません。オフに戻せばサーバー側の情報も削除されます。',
