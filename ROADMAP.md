...
- なし（新モード追加サイクル: 空間・変化検出・音/色の3モードすべて実装完了）
...
- [ ] 新3モード（空間・変化検出・音/色）のE2Eスモークテスト追加
- [ ] 新3モードの内容をCLAUDE.mdのFeature requirementsセクションに反映
...
- [x] 学習データのエクスポート/インポート（JSONバックアップ）機能（2026-08-01）
- [x] 結果画面に「結果をシェア」機能を追加（`navigator.share`＋クリップボードフォールバック、2026-08-01）
